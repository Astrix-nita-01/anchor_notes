...
import { BookOpen, Mail, Lock, Eye, EyeOff, User, GraduationCap, ArrowRight, Sparkles, CheckCircle } from 'lucide-react';
      ...
      <div className="relative flex items-center justify-center min-h-screen px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-8">
            ...
            <div className="flex items-center justify-center px-4 py-2 rounded-full bg-blue-100 text-blue-800 text-sm font-medium mb-6 border border-blue-200">
            ...
            <p className="text-gray-600">
              Start sharing knowledge and excel together
            </p>
          </div>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      className={`pl-10 ${errors.university ? 'border-red-500' : ''}`}
                ...
                <Button 
                  type="submit" 
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-6 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200"
                >
                  {isLoading ? (
                    <>
          ...
          <div className="mt-8 bg-white/60 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Why Join Anchor Notes?</h3>
            <div className="space-y-3">
              ...
              <div className="flex items-center text-sm text-gray-700">
                <CheckCircle className="h-4 w-4 text-green-500 mr-3 flex-shrink-0" />
                Build your academic reputation in the community
              </div>
            </div>
          </div>
        </div>
